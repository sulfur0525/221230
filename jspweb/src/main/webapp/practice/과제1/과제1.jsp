...
<link href="/jspweb/practice/과제1/staff.css" rel="stylesheet">
</head>
<body>
	...
	<div class="wrap">
		...
		<div class="box1">
			...
			<form class="insertForm">
				사원명 : 	<input type="text" 		class="sname" 	name="sname" maxlength="10"> 
				
				<br>
				직급 :	<select 				class="sclass" 	name="sclass">
							<option>인턴</option>
							<option>사원</option>
							<option>대리</option>
							<option>부장</option>
				...
				<br>
				고용형태 :	<select 				class="stype" 	name="stype">
							<option>계약직</option>
							<option>정규직</option>
							<option>임원</option>
						</select><br>
				
				부서 :	<select 				class="field" 	name="field">
							<option>인사팀</option>
							<option>영업팀</option>
							<option>개발팀</option>
						</select>
				...
				<br>
				입사일 :	<input type="date" 		class="edate" 	name="edate">
	...
	<div class="update_modal_wrap">
		<div class="update_modal_box">
			<form class="updateForm">
				사원번호 : <span class="update_sno" 	name="update_sno" ></span> <br>
				사원사진 :	
				...
				사원명 : 	<input type="text" 		class="update_sname" 	name="update_sname"> 
				
				<br>
				직급 :	<select 				class="update_sclass" 	name="update_sclass">
							<option>인턴</option>
							<option>사원</option>
							<option>대리</option>
							<option>부장</option>
				...
				<br>
				고용형태 :	<select 				class="update_stype" 	name="update_stype">
							<option>계약직</option>
							<option>정규직</option>
							<option>임원</option>
						</select><br>
				
				부서 :	<select 				class="update_field" 	name="update_field">
							<option>인사팀</option>
							<option>영업팀</option>
							<option>개발팀</option>
						</select>
				...
				<br>
				입사일 :	<span class="update_edate" 	name="update_edate"></span>
				
				<br>
				퇴사일 :	<input type="date" class="update_ddate" 	name="update_ddate">
				
				<br>
				퇴사사유 :	<input type="text" class="update_dcontent" 	name="update_dcontent">
